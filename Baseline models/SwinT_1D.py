...
class PatchEmbed1D(nn.Module):
    ...
    def __init__(self, patch_size=1, in_chans=3, embed_dim=128, norm_layer=None):
        super().__init__()
...
# def swin_small_patch4_window7_224(num_classes: int = 1, **kwargs):
#     # trained ImageNet-1K
#     # https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_small_patch4_window7_224.pth
...
# def swin_base_patch4_window7_224(num_classes: int = 1, **kwargs):
#     # trained ImageNet-1K
...
# def swin_base_patch4_window12_384(num_classes: int = 1, **kwargs):
#     # trained ImageNet-1K
#     # https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_base_patch4_window12_384.pth
#     model = SwinTransformer1D(in_chans=2,
#                             patch_size=4,
#                             window_size=12,
#                             embed_dim=128,
#                             depths=(2, 2, 18, 2),
...
# def swin_base_patch4_window12_384_in22k(num_classes: int = 1, **kwargs):
#     # trained ImageNet-22K
...
# def swin_large_patch4_window7_224_in22k(num_classes: int = 1, **kwargs):
#     # trained ImageNet-22K
...
# def swin_large_patch4_window12_384_in22k(num_classes: int = 1, **kwargs):
#     # trained ImageNet-22K
